                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="jumlah" id="whjember" class="form-control" readonly>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                                    ...
                                    <tbody>
                                        <?php foreach ($stok as $a) : ?>
                                            <tr>
                                                ...
                                                <td><?= $a['whjember']; ?></td>
                                                <td>
                                                    <button class="btn btn-x btn-info" id="select" data-id_barang="<?= $a['id_barang'] ?>" data-nama="<?= $a['nama'] ?>" data-tipe="<?= $a['tipe'] ?>" data-satuan="<?= $a['satuan'] ?>" data-whjember="<?= $a['whjember'] ?>">
